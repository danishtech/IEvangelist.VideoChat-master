    ...
    public class VideoService : IVideoService
    {
        ...
        public VideoService(Microsoft.Extensions.Options.IOptions<TwilioSettings> twilioOptions)
        {
          ...
          ?? throw new ArgumentNullException(nameof(twilioOptions));
            _twilioSettings.AccountSid = "AC46f25608174d43140c4721fc348ec85c";
            _twilioSettings.ApiKey = "SK6611519893e8639ba89358bcd20782de";
            _twilioSettings.ApiSecret = "bIgyQwrYi8hSaRAnCWhfXAmtOnC6d3kz";
        ...
        readonly string[] _adjectives =
        {
            ...
            "Unique", "Vivacious", "Wicked", "Xenophobic", "Yawning", "Zesty","Test"
        };
